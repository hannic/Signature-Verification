...
AllTaskArgument.result_path='/home/ksl/On_line_Signature_verification/MCYT/MCYT_Result/2011062902';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for i=4:20
    AllTaskArgument.iterations=i;
    AllTaskArgument.result_path=['/home/ksl/On_line_Signature_verification/MCYT/MCYT_Result/201106290' num2str(i-2)];
