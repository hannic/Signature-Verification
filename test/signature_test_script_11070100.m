...
AllTaskArgument.result_path='/home/ksl/On_line_Signature_verification/MCYT/MCYT_Result/2011063000';
...
AllTaskArgument.angle_normalization=1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for i=1:3
    AllTaskArgument.smooth_width=i;
    for j=i/3:i/3:i
    AllTaskArgument.smooth_sigma=j;
    AllTaskArgument.result_path=['/home/ksl/On_line_Signature_verification/MCYT/MCYT_Result/2011070100_' num2str(i) '_' num2str(j)];
