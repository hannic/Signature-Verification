...
AllTaskArgument.task_path='/home/ksl/On_line_Signature_verification/ESRA/ESRA_dev/partition-DS2-50';
%the path of  result folder
AllTaskArgument.result_path='/home/ksl/On_line_Signature_verification/ESRA/ESRA_dev/result/Plot_signature';

%the path of signature folder
AllTaskArgument.data_path='/home/ksl/On_line_Signature_verification/ESRA/ESRA_dev';
%the type of signature database
% 1 ESRA
% 2 MCYT
AllTaskArgument.data_type=1;
...
AllTaskArgument.select_feature=[1:6 11:14];
%is removed hidden strokesd
% 0 not removed it
% 1 removed it
